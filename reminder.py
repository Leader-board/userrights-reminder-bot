...
def get_users_expiry(wiki_name):
    cnx = mysql.connector.connect(option_files='/data/project/permissions-expiry-reminder/userrights-reminder-bot/replica.my.cnf', host=f'{wiki_name}.analytics.db.svc.wikimedia.cloud',
                                  database='meta_p')
    query="""
